			...
			<div class="modal-content">
				                    ...
				                    <div class="mail-body">
				                        <form class="form-horizontal" >
				                            ...
				                            <div class="form-group">
				                                ...
				                                <div class="col-sm-9">
				                                    <input type="text" onfocus="clearTip();"  placeholder="(用于官网主页产品介绍,建议少于125字)" id="about" class="form-control" >
				                                </div>
				                            </div>
				                            <div class="form-group">
				                                <label class="col-sm-3 control-label">产品详情：</label>
				                                <div class="col-sm-9">
				                                	<button type="button" id="editactive" onclick="toAddPro()" style="line-height: 0.429;" class="btn btn-default form-control">文字编辑</button>
				                                    <button type="button" id="editdisabled" disabled   style="line-height: 0.429;" class="btn btn-default form-control">文字编辑</button>
				...
				<div class="modal-footer">
					...
					<button id="updateBtn" type="button" class="btn btn-success" 
							data-dismiss="modal">更新产品
					</button>
					<button id="deleteBtn" type="button" class="btn btn-danger" 
							data-dismiss="modal">删除产品
					</button>
