			...
			<div class="modal-content">
				                        ...
				                        <form class="form-horizontal" >
				                        	<div class="form-group">
				                                ...
				                                <div class="col-sm-9">
				                                    ...
				                                    <input type="text" id="uid_" disabled class="form-control" >
				                                </div>
				                            </div>
				                            <div class="form-group">
				                                <label class="col-sm-3 control-label">类别名称：</label>
				                                <div class="col-sm-9">
				                                    <input type="text" id="name" onfocus="clearTip()" onkeyup="changeBtn(this.value);" placeholder="(必填)" class="form-control" >
				                                </div>
				                            </div>
				                            <div class="form-group">
				                            ...
				                            <div class="form-group">
				                                ...
				                                <div class="col-sm-9">
				                                	<div id="img"></div>
				                                    <button id="btnactive" type="button" onclick="toUpload()" style="line-height: 0.429;display:none;" class="btn btn-default form-control">上传图片</button>
				                                    <button id="btndisabled" type="button" disabled style="line-height: 0.429;display:none;" class="btn btn-default form-control">上传图片</button>
				                                </div>
				                            </div>
				...
				<div class="modal-footer">
					...
					<button id="updateBtn" type="button" class="btn btn-success" 
							data-dismiss="modal">更新类别
					</button>
					<button id="deleteBtn" type="button" class="btn btn-danger" 
							data-dismiss="modal">删除类别
					</button>
