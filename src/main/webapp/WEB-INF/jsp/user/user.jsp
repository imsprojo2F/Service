            ...
            <div class="container" style="">
                <div class="row">
                    <div class="col-lg-12 ">
                        ...
                        <button onclick="operateModal(true,'add')" type="button" class="btn btn-success btn-md">
			...
			<div class="modal-content">
					...
					<form class="form-horizontal" role="form">
						<div class="form-group ">
							...
							<div class="col-sm-10">
								...
								<input onfocus="clearTip()" class="form-control" onkeyup="this.value = this.value.replace(/[^0-9a-zA-Z@.\-]/g,'');validate(this.value);" id="account" type="text"  placeholder="账号不少于5个字符">
							</div>
						</div>
						<div class="form-group ">
							<label class="col-sm-2 control-label" for="password">密码</label>
							<div class="col-sm-10">
								<input class="form-control" onfocus="clearTip()" id="password" type="password"  placeholder="密码不少于5个字符">
							</div>
						</div>
				...
				<div class="modal-footer">
					...
					<button id="updateBtn" type="button" class="btn btn-success" 
							data-dismiss="modal">更新用户
					</button>
					<button id="deleteBtn" type="button" class="btn btn-danger" 
							data-dismiss="modal">删除用户
					</button>
